// The time complecity basically depends on the prodecure that you are adopting. 
...
// Now, assuming we compare all the elements and go through it and compare to others. For example, we go to 2 first and then compare it to all the other elements. 2 to 5, 2 to 9, 2 to 6. And after this procede all (compate to 2). We go to the next element, which is 5. So we compare 5 to 2, 5 to 9, 5 to 6, etc. 
